...
export default function GalleryPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Main content area */}
      <div className="flex-grow w-full px-6 py-12">
        ...
        {state === "loading" && (
          <div className="flex justify-center items-center h-64">
            <div className="w-12 h-12 border-4 border-[#AA60C8] border-t-transparent rounded-full animate-spin"></div>
          </div>
        )}
